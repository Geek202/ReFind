...
import me.geek.tom.refind.asm.ConstructorScanningMethodVisitor;
...
public class ConstructorSearch implements Refind.Search {
    @Override
    public void search(JarFile jar, JarEntry entry, String search, Consumer<String> handler) throws IOException {
        ClassReader reader = new ClassReader(jar.getInputStream(entry));
        reader.accept(new MethodScanningClassVisitor(handler, search, ConstructorScanningMethodVisitor::new), 0);
    }
}
